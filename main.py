...
HELP_TEXT = (
    "Я помогу хранить задачи и делать план на день.\n\n"

    "1) Быстрое добавление задач\n"
    "• Добавить задачу на сегодня:\n"
    "  /add 14:30 Позвонить маме\n\n"
    "• Добавить с деталями (не обязательно):\n"
    "  /add 18:10 p=high m=60 cat=study Подготовка к экзамену\n"
    "  p=low/med/high — важность\n"
    "  m=число — сколько минут займёт\n"
    "  cat=... — категория\n"
    "  due=YYYY-MM-DD — дедлайн\n"
    "  diff=easy/med/hard — сложность\n\n"

    "2) Просмотр задач\n"
    "• Задачи на сегодня:\n"
    "  /today\n"
    "• Только невыполненные или только выполненные:\n"
    "  /today todo\n"
    "  /today done\n"
    "• На неделю:\n"
    "  /week\n"
    ...
    "3) Выполнение и изменения\n"
    "У каждой задачи есть номер (ID) — он показывается в списке.\n"
    "• Отметить выполненной:\n"
    "  /done 12\n"
    "• Вернуть обратно (не выполнено):\n"
    "  /undo 12\n"
    "• Удалить:\n"
    "  /delete 12\n"
    "• Перенести:\n"
    "  /move 12 tomorrow\n"
    "  /move 12 2026-01-11\n"
    "• Изменить (можно менять время, текст, параметры):\n"
    "  /edit 12 19:00 Новый текст\n"
    "  /edit 12 p=high m=45 cat=study Новый текст\n\n"

    "4) Повторяющиеся дела\n"
    "• Каждый день:\n"
    "  /repeat add daily 09:00 Вода и зарядка\n"
    "• По будням:\n"
    "  /repeat add weekdays 12:00 Обед\n"
    "• Раз в неделю:\n"
    "  /repeat add weekly mon 18:00 Тренировка\n"
    "• Посмотреть повторы:\n"
    "  /repeat list\n"
    "• Удалить повтор:\n"
    "  /repeat delete 3\n\n"

    "5) Время (чтобы план был реалистичным)\n"
    "• Указать, когда ты сегодня свободен:\n"
    "  /availability 18:00-22:00\n"
    "• Указать, когда ты сегодня занят:\n"
    "  /busy 19:00-19:30\n\n"

    "6) План на день\n"
    "• Сделать план (разложить задачи по времени):\n"
    "  /plan generate\n"
    "• Показать план:\n"
    "  /plan show\n"
    "• Пересчитать план:\n"
    "  /plan regenerate\n"
    "• Зафиксировать (чтобы случайно не перегенерить):\n"
    "  /plan lock\n\n"

    "7) Состояние (для умного плана)\n"
    "• Записать состояние на сегодня:\n"
    "  /mood calm 7.5 clear 8 3\n"
    "  (настроение, сон_часы, фокус, энергия 1–10, стресс 1–10)\n"
    "• Посмотреть состояние:\n"
    "  /mood_today\n\n"

    "Если хочешь — просто напиши: \"как добавить задачу\" или \"как сделать план\"."
)
